...
namespace DAL
{
    public class DAL_ChiTiet_LichDat_SanBong
    {
        ...
        {
            return DAL_DB.Instance.ThuThi_Query("Select * From [dbo].[ChiTietLichDat_SanBong] Where ID_LDSB = '" + ID_LDSB + "' ORDER BY KhungGio_BatDat ASC");
        }
        ...
        {
            return DAL_DB.Instance.ThuThi_NonQuery("DELETE FROM [dbo].[ChiTietLichDat_SanBong] WHERE ID_LDSB = '"+ ID_LDSB + "'") > 0 ? true : false;
        }
    }
}
